...
class _$SearchHistoryImpl extends _SearchHistory {
  _$SearchHistoryImpl({required this.query}) : super._();
...
abstract class _SearchHistory extends SearchHistory {
  factory _SearchHistory({required final String query}) = _$SearchHistoryImpl;
